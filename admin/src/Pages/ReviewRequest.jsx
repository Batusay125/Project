    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton style={{backgroundColor: "#00828c"}}>
          <Modal.Title style={{color: "#fff"}}>Application details</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <div className="d-flex">
            <div className="w-50">
            ...
            <div>
                ...
                <p>: {data.fullname}</p>
                <p>: {data.phone}</p>
                <p>: {data.province} {data.city} {data.barangay}</p>
            ...
            <div>
                ...
                <img src={`http://localhost:8081/uploads/${data.home_environment_image_path
}`}/>
            </div>
